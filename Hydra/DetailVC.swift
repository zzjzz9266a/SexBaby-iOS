...
class DetailVC: UITableViewController {
    ...
    func loadData(){
        Alamofire.request("http://zhangzhijie.space:8080/api/detail/\(id)", method: .post, parameters: ["province": province]).responseObject { (response: DataResponse<Member>) in
